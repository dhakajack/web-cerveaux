...
"Dehors[unicode 160]? demande la souris. Je suis tout à fait à mon aise ici. Qu'offre le monde extérieur[unicode 160]? Rien que des ennuis. J'ai hérités des terres ici et même un titre -- vous rendez-vous compte que je suis un marquis[unicode 160]? Oui, je ne plaisante pas. Je suis le dix-huitième marquis de ma ligne. Tu veux que je sacrifie tout ça[unicode 160]?[line break]-- Il y a un monde entier[unicode 160]! plaide le chien[line break]-- J'ai vécu là, ajoute la tranche de cerveau. Je crois que je vivais non loin d'ici avec ma copine… comment s'appelait-elle[unicode 160]?", 

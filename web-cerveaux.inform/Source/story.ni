...
After going north from Couloir 1 when the labPathDoor is open for the first time:
	now the BlockChatterFlag is true;
	say "«[unicode 160][italic type]Oh là là ! dit Lucky avec joie.[line break]-- Pourquoi es-tu si content ?[line break]-- Vois-tu cette boîte-là ? Voilà la vraie boîte magique[unicode 160]:[unicode 160]le frigo ![line break]-- Est-ce qu'on fait des voyages dans un frigo ?[line break]-- Non, on mange ce qu'on trouve là-dedans ![roman type][unicode 160]»[paragraph break]";
	try looking.
...
To say firstUnlocked:
	...
	say "[paragraph break]«[unicode 160][italic type]Attends, dit le chien. Quel est ce nouveau truc ?[line break]-- Il faut introduire un code pour ouvrir les portes avec des serrures électroniques.[line break]-- Et tu te souviens de ce code ? demande la souris.[line break]-- Apparemment[roman type].[unicode 160]»".
...
After eating the chien:
	...
	say "[line break]D'instinct, vous dévorez son cerveau et jetez le corps dans la cage. Encore une fois, de nouvelles pensées envahissent votre esprit.[paragraph break][italic type]Je vous préviens[unicode 160]:[unicode 160]si vous approchez de ma cage, je vous mordrai. Arrêtez ! Sans blague… [paragraph break]Mais, qu'est-ce qui se passe ? Qui est ce chien mort dans ma cage… dont le sang coule sur mon coussin préféré ?[paragraph break]Et pourquoi est-ce que je me tiens debout sur deux jambes à la façon des êtres humains ? C'est en fait plus facile que j'aurais pensé.";
	increment the consciousness of the player;
	increment the knownCommands of the player.
...
CuredDialogue is { 
"C'est fait, dit la scientifique. Je ferai l'appel[unicode 160]:[unicode 160]Lucky ?[line break]-- Présent.[line break]-- Le Marquis de Souris ?[line break]-- Oui. Ici.[line break]-- Et la tranche de cerveau de Julien ?[line break]-- Présent.[line break]-- Bon, dit Isabelle, il me semble que nous sommes tous arrivés sain et sauf.",
